...
<>
             ...
             <section>
                <div className={styles.itemsListContainer}>
                    {cartItems.map((item) =>(
                        ...
                        <button onClick={() => {removeFromCart(item._id)}}> <FiMinusCircle /> Remove item</button>
                        </div>
                        </div>
                    ))}
                </div>
        ...
        <ConfirmOrderPopup open={confirmPopupOpen} onClose={handleOpenPopup} onConfirm={handleConfirmOrder}></ConfirmOrderPopup>
</>
